...
//    private RedissonClient redissonClient;
            ...
            while (true) {
                ...
                list.forEach(confirmOrder -> {
                    try {
                        ...
                        if (e.getE().equals(AppExceptionEnum.CONFIRM_ORDER_TICKET_COUNT_ERROR)) {
    ...
    private void sell(ConfirmOrder confirmOrder) {
        ...
        try {
            ...
            throw new AppException(AppExceptionEnum.CONFIRM_ORDER_EXCEPTION);
        }
    }
        ...
        for (ConfirmOrderTicketReq ticketReq : req.getTickets()) {
            ...
            switch (seatTypeEnum) {
                case YDZ -> {
                    ...
                    if (countLeft < 0) {
                        throw new AppException(AppExceptionEnum.CONFIRM_ORDER_TICKET_COUNT_ERROR);
                    }
     ...
     * @param seatType 座位类型，即一等座或二等座等等
     * @param column 座位列，即A、B等等
     * @param offsetList 若有多个座位选座，后面座位相对第一个座位的偏移量
     */
